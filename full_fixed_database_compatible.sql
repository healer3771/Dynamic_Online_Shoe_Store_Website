...
--
DROP TABLE IF EXISTS `shoeCategories`;
CREATE TABLE IF NOT EXISTS `shoeCategories` (
  `shoeCategoryID` int(11) NOT NULL AUTO_INCREMENT,
  `shoeCategoryName` varchar(255) NOT NULL,
  `dateAdded` datetime NOT NULL,
  PRIMARY KEY (`shoeCategoryID`)
...
--
DROP TABLE IF EXISTS `shoeManagers`;
CREATE TABLE IF NOT EXISTS `shoeManagers` (
  `shoeManagerID` int(11) NOT NULL AUTO_INCREMENT,
  `emailAddress` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL,
  `firstName` varchar(60) NOT NULL,
  `lastName` varchar(60) NOT NULL,
  PRIMARY KEY (`shoeManagerID`),
...
CREATE TABLE IF NOT EXISTS `shoes` (
  ...
  `dateAdded` datetime NOT NULL,
  PRIMARY KEY (`shoeID`),
  UNIQUE KEY `shoeCode` (`shoeCode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci AUTO_INCREMENT=80 ;
